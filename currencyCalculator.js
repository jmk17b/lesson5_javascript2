...
function calculateCurrency(){
        ...
        *********************************************************************************************/
         ...
         if (country == 0){
            ...
            document.getElementById("currencyExchangeInfo").innerHTML = "Please select a currency to calculate.";   
         }
         ...
         *                                INSERT YOUR CODE BELOW!
        ***********************************************************************************************/                                                                                                               
            document.getElementById("currencyExchangeInfo").innerHTML = "The exchange rate of " + usdAmount + " US dollars to " + countryName + " is " + exchangeRate;
